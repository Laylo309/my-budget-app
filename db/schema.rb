...
ActiveRecord::Schema.define(version: 2022_01_13_143754) do
  ...
  add_foreign_key "activities_categories", "activities"
  add_foreign_key "activities_categories", "categories"
